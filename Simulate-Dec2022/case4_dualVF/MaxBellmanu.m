function [V1, xp] = MaxBellmanu( Par, V0, Grid )
%MAXBELLMAN -- Upward PF
...
fB = Bellmanu(Par, V0, Grid, B);
fC = Bellmanu(Par, V0, Grid, C);
...
for it = 1: MAXIT
      ...
      fB_fulleval = Bellmanu(Par, V0, Grid, B);
      ...
      fC_fulleval = Bellmanu(Par, V0, Grid, C);
      % Bellman can only evaluate the whole grid
      fC(~I) = fC_fulleval(~I);
